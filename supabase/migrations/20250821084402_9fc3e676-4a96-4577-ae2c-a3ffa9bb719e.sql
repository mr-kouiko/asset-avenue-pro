-- Fix the vendor welcome email function to not use net.http_post
-- Drop the existing trigger first
DROP TRIGGER IF EXISTS send_vendor_welcome_email_trigger ON auth.users;

-- Drop the existing function
DROP FUNCTION IF EXISTS public.send_vendor_welcome_email();
