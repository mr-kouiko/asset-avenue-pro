-- Fix Security Definer Views issue by recreating views as regular views
-- Views inherit security from underlying tables, so no need for RLS on views themselves
