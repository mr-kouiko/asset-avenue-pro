            ...
            >
              ...
              <div className="flex justify-center items-center flex-1 min-h-0 overflow-hidden">
                ...
                {previewFile.type.startsWith('video/') && (
                  <div className="w-full flex-1 min-h-0 max-h-[calc(95vh-8rem)] flex items-center justify-center bg-black rounded-lg overflow-hidden [&_video]:max-h-full [&_video]:max-w-full [&_video]:w-full [&_video]:h-full [&_video]:object-contain">
                    <MediaPlayer 
                      src={(() => {
