...
export interface CalendarEvent {
  ...
  icon: LucideIcon;
  searchQuery: string;
  themeId: string; // Maps to themeSearch.ts definitions
  description: string;
  gradient: string;
...
// Calendar events for 2025-2026 with images and theme IDs for semantic search
export const calendarEvents: CalendarEvent[] = [
  ...
  },
  {
    ...
    icon: Heart,
    searchQuery: 'valentine love heart romantic couple',
    themeId: 'valentine',
  ...
  // March 2025
  {
    ...
    icon: Moon,
    searchQuery: 'ramadan islamic mosque prayer lantern',
    themeId: 'ramadan',
