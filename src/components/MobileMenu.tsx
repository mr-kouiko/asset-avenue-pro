...
export const MobileMenu = ({ userRole, onAuthClick }: MobileMenuProps) => {
  ...
  const labels = {
    ...
    trending: language === 'fr' ? 'Tendances' : 'Trending',
    creatorTools: language === 'fr' ? 'Outils Créateur' : 'Creator Tools',
    upload: language === 'fr' ? 'Publier du contenu' : 'Upload Content',
    sellerDashboard: language === 'fr' ? 'Tableau vendeur' : 'Seller Dashboard',
    account: language === 'fr' ? 'Compte' : 'Account',
    cart: language === 'fr' ? 'Panier' : 'Cart',
    infinity: 'Infinity',
    myAccount: language === 'fr' ? 'Mon compte' : 'My Account',
    signOut: language === 'fr' ? 'Se déconnecter' : 'Sign Out',
    signIn: language === 'fr' ? 'Se connecter' : 'Sign In',
    admin: 'Administration',
    explore: language === 'fr' ? 'Explorer' : 'Explore',
    dashboard: language === 'fr' ? 'Tableau de bord' : 'Dashboard',
    purchases: language === 'fr' ? 'Mes achats' : 'My Purchases',
    searchPlaceholder: language === 'fr' ? 'Rechercher photos, vidéos, audio...' : 'Search photos, videos, audio...',
    hello: language === 'fr' ? 'Bonjour' : 'Hello',
    guest: language === 'fr' ? 'Bienvenue' : 'Welcome',
  };
